...
*Note: The following Pictures are from Windows, but the steps are mostly the same except *
## 4.1 OBS
...
Opening the launch.sh in the Terminal app will always start up NOALBS from within the directory it is in.  You can also make an Alias to the launch.sh and put it on the desktop and run it that way.
---
# 5 - Make OBS pretty
